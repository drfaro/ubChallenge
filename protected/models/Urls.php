...
class Urls extends CActiveRecord
{
	 ...
	 *
	 * @return CActiveDataProvirder the data provider that can return the models based on the search/filter conditions.
	 */
	public function search()
	{
		...
		return new CActiveDataProvider('urls', array(
			'criteria'=>$criteria,
		));
	}
